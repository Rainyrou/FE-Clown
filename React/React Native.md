...
- 调用原生方法时，JavaScript 线程将调用信息如参数和方法名等通过 Bridge 传递给 Native 线程，Native 线程执行对应 Native 代码并将结果返回给 JavaScript 线程
...
- 一旦 Native UI 组件暴露给 JavaScript，它可以像正常的 React 组件一样被使用
